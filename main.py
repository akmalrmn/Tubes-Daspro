...
while berhenti == False:
  ...
  masukan = input(">>> ")
  sleep(0.5)
  login_status, idx_usn, user, idx_rng, candi, bahan_bangunan = run(masukan, login_status, idx_usn, user, idx_rng, candi, bahan_bangunan) # memanggil fungsi dari commands.py
  print()
